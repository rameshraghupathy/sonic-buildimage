...
#
# Slim/evaluation builds can use the GRUB packages provided by the
# configured Debian distribution mirror instead of rebuilding SONiC's
# patched GRUB from salsa.debian.org.
#
# Default remains the existing SONiC behavior.
#
USE_DISTRO_GRUB ?= n
export USE_DISTRO_GRUB

ifeq ($(USE_DISTRO_GRUB),n)
